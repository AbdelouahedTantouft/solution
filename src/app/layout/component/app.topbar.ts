...
<!-- Bouton Profile -->
<button type="button" class="layout-topbar-action" (click)="toggleProfileCard()">
    <i class="pi pi-user"></i>
    <span>Profile</span>
</button>

<!-- Overlay et Carte Profil -->
<div class="overlay" *ngIf="showProfileCard">

    <div class="profile-card">
    <button type="button" class="close-btn" (click)="toggleProfileCard()">
        ...
        <div class="card">
            ...
            <button type="button" class="cancel" (click)="toggleProfileCard()">Annuler</button>
<button type="submit" class="save">Enregistrer</button></div>
    </div>
</div>
...
export class AppTopbar {
    items!: MenuItem[];
    showProfileCard = false; // Gérer l'affichage du formulaire
