...
function CountrySelectComponent_mat_option_8_Conditional_5_span_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const country_r3 = ɵɵnextContext(2).$implicit;
    ɵɵadvance();
...
function CountrySelectComponent_mat_option_8_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵtextInterpolate(country_r3.translations[ctx_r1.lang]);
    ɵɵadvance();
...
function CountrySelectComponent_mat_option_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = ɵɵnextContext();
    ɵɵproperty("value", country_r3);
    ɵɵadvance(2);
    ɵɵconditional(ctx_r1.showFlag === true ? 2 : -1);
    ɵɵadvance();
    ɵɵconditional(ctx_r1.alpha2Only === true ? 3 : ctx_r1.alpha3Only === true ? 4 : 5);
  }
}
var countries = [{
  alpha2: "af",
...
var CountrySelectComponent = class _CountrySelectComponent {
  /**
   ...
   */
  set selectedCountryByAlpha2(alpha2) {
   ...
   */
  set selectedCountryByAlpha3(alpha3) {
   ...
   */
  set selectedCountryByCurrentTranslation(name) {
    const country = countries.find((c) => c.translations[this.lang] === name);
    if (country) {
      this.formControl.setValue(country);
    }
  }
  ...
  static ɵfac = function CountrySelectComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CountrySelectComponent)();
  };
  static ɵcmp = ɵɵdefineComponent({
    type: _CountrySelectComponent,
    ...
    inputs: {
      ...
      selectedCountryByAlpha2: "selectedCountryByAlpha2",
      selectedCountryByAlpha3: "selectedCountryByAlpha3",
      selectedCountryByCurrentTranslation: "selectedCountryByCurrentTranslation",
    ...
    template: function CountrySelectComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵadvance();
        ɵɵproperty("formControl", ctx.formControl)("matAutocomplete", auto_r4)("disabled", ctx.disabled)("required", ctx.required);
        ɵɵadvance();
        ɵɵconditional(ctx.showFlag === true ? 4 : -1);
        ɵɵadvance();
        ɵɵproperty("displayWith", ctx.displayFn.bind(ctx));
        ɵɵadvance(2);
        ɵɵproperty("itemSize", "25")("ngStyle", ɵɵpureFunction1(15, _c07, ctx.height));
        ɵɵadvance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CountrySelectComponent, [{
    type: Component,
    args: [{
...
//# sourceMappingURL=@wlucha_ng-country-select.js.map
